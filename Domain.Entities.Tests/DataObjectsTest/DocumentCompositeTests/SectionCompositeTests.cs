...
namespace Domain.Entities.Tests.DataObjectsTest.DocumentCompositeTests
{
    public class SectionCompositeTests
    {
        ...
        public void SetSubsections_Should_Set_New_Subsections()
        {
            ...
            var subsections = new List<SectionComponent> { new SectionComposite("Subsection 1", 2, new LanguagesComponent(23)), new SectionComposite("Subsection 2", 3, new LanguagesComponent(2)) };
        ...
        public void SetSubsections_Should_Clear_Subsections_When_Null_Subsections_Set()
        {
            // Arrange
            var sectionComposite = new SectionComposite("Composite Section", 1, new LanguagesComponent(2));
            var subsections = new List<SectionComponent> { new SectionComposite("Subsection 1", 2, new LanguagesComponent(2)) };
            sectionComposite.SetSubsections(subsections);
            // Act // Assert
