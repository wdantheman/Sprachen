...
{
    public class PersistenceSectionsInDocumentCRUDUseCase
    {
        ...
        public PersistenceSectionsInDocumentCRUDUseCase(ILanguagesComponentSettingsService languagesComponentService, IObjectIdentifierService identityCreator, ISectionInDocumentCRUDPersistenceService sectionPersistenceService)
        {
